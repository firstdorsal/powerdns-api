**This is a mirror of [git.y.gy/firstdorsal/powerdns-api](https://git.y.gy/firstdorsal/powerdns-api)**
# Powerdns API
...
#### powerdnsClient.setHomogeneousRecords(records, [domain]) ⇒ <code>boolean</code>
